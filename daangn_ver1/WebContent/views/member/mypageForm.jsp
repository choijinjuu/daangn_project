...
<body>
	...
	<div id="enroll_wrap">
		<div id="enroll_text">
			...
			<div><span onclick="location.href='<%=contextPath%>/myBoard.me?currentPage=1'"><strong>나의 글</strong></span></div>
			<div><span onclick="location.href='<%=contextPath%>/myReply.me?currentPage=1'"><strong>나의 댓글</strong></span></div>
		</div>
		<hr id="enroll_text_hr">
        <div id="enroll_form">
        	<div id="enroll_title"><strong>회원정보 수정</strong></div>
            <form action="<%=contextPath%>/updateMy.me" method="post" enctype="multipart/form-data">
            	...
            	<div class="enroll_area" id="profile_area">
                	...
                	<!-- 프로필 미리보기 영역 -->
		            <img id="profileImg" name="profileImg" src="<%=loginMember.getProfile_img()%>">
                </div>
                <!--파일 첨부 영역 -->
                ...
                <div class="enroll_area">
	                ...
	                <input class="enroll_area2" type="text" name="memberId" id="memberId" value="<%=loginMember.getMemberId()%>" style="color: rgb(144, 144, 144);" disabled>            
                </div>
                <div class="enroll_area" id="pwd_area">
                	<span><strong>비밀번호</span>
	                <input class="enroll_area2" type="password" name="memberPwd" id="memberPwd" value="<%=loginMember.getMemberPwd()%>">
	                <button type="button" onclick="togglePassword();">비밀번호 보기</button>      
                </div>
                <div class="enroll_area">
                	<span><strong>이메일</span>
	                <input class="enroll_area2" type="email" name="email" id="email" value="<%=loginMember.getEmail()%>">            
                </div>
                <div class="enroll_area">
                	<span><strong>주소</span>
	                <input class="enroll_area2" name="address" id="address" type="text" value="<%=loginMember.getAddress() %>"  onclick="postcode();">            
                </div>
                <div class="enroll_area">
                	<span><strong>정보 수정일</span>
	                <input class="enroll_area2" type="text" name="enrollDate2" id="enrollDate2" value="<%=loginMember.getUpdateDate()%>" style="color: rgb(144, 144, 144);" disabled>            
                </div>
                <div class="enroll_area">
                	<span><strong>가입일</span>
	                <input class="enroll_area2" type="text" name="enrollDate" id="enrollDate" value="<%=loginMember.getEnrollDate()%>" style="color: rgb(144, 144, 144);" disabled>            
                </div>
                <div id="enroll_go">
